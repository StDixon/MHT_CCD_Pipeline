...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 23 16:37:18 2018
...
class DataRecordForm(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.inputs['Light'] = LabelInput(
                ...
                input_class=ValidatedSpinbox, 
                input_var=tk.DoubleVar(),
                input_args={"from_": '0.0', "to": '100.0', "increment": '.01'})
        ...
        self.inputs['Temperature'] = LabelInput(
                ...
                input_class=ValidatedSpinbox, 
                input_var=tk.DoubleVar(),
                input_args={"from_": '4.0', "to": '40.0', "increment": '.01'})
        ...
        self.inputs['Min Height'] = LabelInput(
                ...
                input_class=ValidatedSpinbox, 
                input_var=tk.DoubleVar(),
                input_args={"from_": '0.0', "to": '1000.0', "increment": '.01',
